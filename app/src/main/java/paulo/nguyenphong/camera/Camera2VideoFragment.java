...
package paulo.nguyenphong.camera;
...
import paulo.nguyenphong.appxblockchainproject.VideoRecordingActivity;
import paulo.nguyenphong.google.cloud.CloudStorage;
import paulo.nguyenphong.hash.Hash;
import paulo.nguyenphong.utils.ButtonClickEventAsyncTask;

public class Camera2VideoFragment extends Fragment
        implements View.OnClickListener, FragmentCompat.OnRequestPermissionsResultCallback,ButtonClickInterface {
    ...
    public static TextView notifiTxt;
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        notifiTxt = (TextView)view.findViewById(R.id.textVertifyVideo);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.video: {
                //((VideoRecordingActivity)getActivity()).beginVoiceReczg();
            ...
            case R.id.info: {
                new ButtonClickEventAsyncTask(this).execute();
                /*Activity activity = getActivity();
                if (null != activity) {
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            String cameraId = getFrontFacingCameraId(manager);//manager.getCameraIdList()[0];
    ...
    public void startEvent() {
        ((VideoRecordingActivity)getActivity()).uploadVideo(mNextVideoAbsolutePath);
        mNextVideoAbsolutePath = null;
    }

    @Override
    public void finishedEvent() {
        ((VideoRecordingActivity)getActivity()).finishedActivity();
    }
